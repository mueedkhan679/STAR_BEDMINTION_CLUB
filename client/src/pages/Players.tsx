  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Players</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage club members</p>
        </div>
        <button
          onClick={() => openModal()}
          ...
          >
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800 dark:text-white">{player.name}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{player.father_name}</p>
